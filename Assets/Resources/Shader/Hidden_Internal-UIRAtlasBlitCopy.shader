...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      ...
                                                      OpEntryPoint Vertex %4 "main" %11 %72 %86 %223 
         ...
         Output struct {f32_4; f32; f32[1];}* %72 = OpVariable Output 
                     ...
                     OpSwitch %93 %102 { Selector = 0, Label = %94 } { Selector = 1, Label = %95 } { Selector = 2, Label = %96 } { Selector = 3, Label = %97 } { Selector = 4, Label = %98 } { Selector = 5, Label = %99 } { Selector = 6, Label = %100 } { Selector = 7, Label = %101 } 
                              ...
                              Uniform f32_4* %208 = OpAccessChain %20 %203 
                                  ...
                                  Input f32* %228 = OpAccessChain %86 %87 
                                         f32 %229 = OpLoad %228 
                                 Output f32* %231 = OpAccessChain vs_TEXCOORD0 %87 
                                                      OpStore %231 %229 
                                 Output f32* %232 = OpAccessChain %72 %22 %68 
                                         f32 %233 = OpLoad %232 
...
; Schema: 0
                                       ...
                                       %1 = OpExtInstImport "GLSL.std.450" 
                                              OpMemoryModel Logical GLSL450 
                                              OpEntryPoint Fragment %4 "main" %12 %134 
