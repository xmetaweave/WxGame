...
namespace DynamicMeshCutter
{
    ...
    public abstract class CutterBehaviour : MonoBehaviour
    {
        ...
        {
            MeshCreationData creationInfo = MeshCreation.CreateObjects(info, DefaultMaterial);
            ...
            if (creationInfo.CreatedObjects == null)
                Debug.LogWarning("Cut created empty objects");
